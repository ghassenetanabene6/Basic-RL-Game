...
colors = {
    ...
    'yellow': pygame.Color(252, 243, 207), 
    'red': pygame.Color(203, 67, 53), 
    'darkBlue':pygame.Color(52, 152, 219), 
    'blue': pygame.Color(93, 173, 226)
}
...
def mainGame(emulate, fps_controller, onGameOver, onScore):
    ...
    while True:
        ...
        # GFX
        game_window.fill(colors['yellow'])

        #draw snake_body (head is darkBlue)
